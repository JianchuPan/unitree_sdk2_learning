...
propvec &get_type_props<::UserDataModule::UserData>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, bb_unset, extensibility::ext_final, false));  //::string_data
  props.push_back(entity_properties_t(1, 1, false, get_bit_bound<double>(), extensibility::ext_final, false));  //::float_data
