...
public:
  ...
  int64_t user_id() const { return this->user_id_; }
  int64_t& user_id() { return this->user_id_; }
  void user_id(int64_t _val_) { this->user_id_ = _val_; }
  ...
  {
    (void) _other;
    return user_id_ == _other.user_id_ &&
      name_ == _other.name_ &&
  ...
  while (prop) {
    switch (prop->m_id) {
      ...
      if (!streamer.start_member(*prop))
        return false;
      if (!write(streamer, instance.user_id()))
        return false;
...
bool read(T& streamer, ::HelloWorldData::Msg& instance, entity_properties_t *props) {
  ...
  while (prop) {
    switch (prop->m_id) {
      ...
      if (!streamer.start_member(*prop))
        return false;
      if (!read(streamer, instance.user_id()))
        return false;
      if (!streamer.finish_member(*prop))
        return false;
      break;
...
bool move(T& streamer, const ::HelloWorldData::Msg& instance, entity_properties_t *props) {
  ...
  while (prop) {
    switch (prop->m_id) {
      ...
      if (!streamer.start_member(*prop))
        return false;
      if (!move(streamer, instance.user_id()))
        return false;
      if (!streamer.finish_member(*prop))
        return false;
      break;
...
bool max(T& streamer, const ::HelloWorldData::Msg& instance, entity_properties_t *props) {
  ...
  while (prop) {
    switch (prop->m_id) {
      ...
      if (!streamer.start_member(*prop))
        return false;
      if (!max(streamer, instance.user_id()))
        return false;
      if (!streamer.finish_member(*prop))
        return false;
      break;
