...
propvec &get_type_props<::HelloWorldData::Msg>() {
  ...
  props.push_back(entity_properties_t(1, 0, false, get_bit_bound<int64_t>(), extensibility::ext_final, false));  //::user_id
  props.push_back(entity_properties_t(1, 1, false, bb_unset, extensibility::ext_final, false));  //::name
  props.push_back(entity_properties_t(1, 2, false, bb_unset, extensibility::ext_final, false));  //::message
